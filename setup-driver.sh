...
HEADNODESCRIPTS="setup-nfs-server.sh setup-nginx.sh setup-ssl.sh setup-kubespray.sh setup-kubernetes-extra.sh setup-ingress-controller.sh setup-metrics.sh run-ee-bench.sh setup-end.sh"
